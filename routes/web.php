...
/* * ******** CronController ******* */
Route::get('check-package-validity/{token}', 'CronController@checkPackageValidity')
...
// Sociallite End
/* * ***************************** */
Route::post('tinymce-image_upload-front', 'TinyMceController@uploadImage')
    ->middleware('auth.any')
    ->name('tinymce.image_upload.front');
Route::get('cronjob/send-alerts/{token}', 'AlertCronController@index')
    ->middleware('cron.token')
    ->name('send-alerts');
