                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            El estado de su registro en nuestra bolsa de empleo ha pasado a {{$estado}}
                                            @if($estado == 'Activado' || $estado == 'activado')
                                            ahora podras publicar tus ofertas de vacantes en nuestra plataforma.
                                            @else
                                            ahora no podras publicar tus ofertas de vacantes en nuestra plataforma, comunicate con nosotros para 
