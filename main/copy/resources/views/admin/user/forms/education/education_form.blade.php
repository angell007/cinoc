<div class="modal-body">
    ...
    <div class="form-body">
        ...
        <div class="form-group {!! APFrmErrHelp::hasError($errors, 'date_completion') !!}">
            ...
            {!! Form::label('date_completion', 'Fecha de graduación', ['class' => 'text']) !!}
        ...
        <?php $education_status = ['1' => 'En curso', '2' => 'Incompleto', '3' => 'Graduado'];
        $selected_status = isset($profileEducation) ? $profileEducation->education_status : null; ?>

        <div class="formrow" id="div_education_status">
            {!! Form::select('education_status', ['' => __('Estado de formación')] + $education_status, $selected_status, [
                'class' => 'form-control',
                'id' => 'education_status',
            ]) !!}
            <span class="help-block text-danger education_status-error">
            </span>
        </div>
