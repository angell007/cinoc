<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form class="form" id="add_edit_profile_education_non_formal" method="POST"
            action="{{ route('store.profile.education_non_formal', [$user->id]) }}">{{ csrf_field() }} <div
            ...
            @include('user.forms.non_formal_education.education_form') <div class="modal-footer">

                <button type="button" class="btn btn-large btn-primary"
                    onClick="enviarFormularioEducacionNoFormal();">{{ __('Add Education') }}
