<div class="col-md-3 col-sm-6">
    <div class="jobreqbtn">
        ...
        @else
        <a href="{{url('my-profile#cvs')}}" class="btn"><i class="fa fa-file-text" aria-hidden="true"></i> {{__('Sube tu Currículum ')}}</a>
        @endif
    </div>
    <!-- Side Bar start -->
    <div class="sidebar">
        ...
        <div class="widget">
            ...
            <div class="form-group">
                {!! Form::number('salary_from', Request::get('salary_from', null), array('class'=>'form-control', 'id'=>'salary_from', 'placeholder'=>__('Salario desde'))) !!}
            </div>
            <div class="form-group">
                {!! Form::number('salary_to', Request::get('salary_to', null), array('class'=>'form-control', 'id'=>'salary_to', 'placeholder'=>__('Salario Hasta'))) !!}
            </div>
            <div class="form-group">
                {!! Form::select('salary_currency', ['' =>__('Select Salary Currency')]+$currencies, 'COP', array('class'=>'form-control', 'id'=>'salary_currency', 'selected' => 'true')) !!}
            </div>
            <!-- Salary end -->
