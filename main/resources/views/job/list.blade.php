...
@include('includes.inner_page_title', ['page_title'=>__('Listado de Ofertas Laborales')]) 
        ...
        <div class="modal-content">
            ...
            <form id="submit_alert">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Alerta de empleo</h4>
                ...
                <div class="modal-body">
					...
					<h3>Obtener las últimas alertas <strong>{{ ucfirst(Request::get('search')) }}</strong> de empleo   @if(Request::get('location')!='') <strong>{{ ucfirst(Request::get('location')) }}</strong>@endif directamente a tu email </h3>
