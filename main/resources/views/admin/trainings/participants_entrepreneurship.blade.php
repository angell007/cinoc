...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
         ...
         @include('partials.fileModalUploadedEntrepreneurship')
    ...
    <script>
        ...
        $('#form').on('submit', function(e) {
            ...
            var data = {
                ...
                email: $('#email').val(),
                phone: $('#phone').val(),
                functional_area: $('#functional_area').val(),
                rol: $('#rol').val(),
                status: $('#status').val(),
                sexo: $('#sexo').val(),
                ...
                entrepreneurship_name: $('#entrepreneurship_name').val(),
