...
<div class="form-body">
        ...
        <div class="col-md-6">
            <div class="form-group {!! APFrmErrHelp::hasError($errors, 'image') !!}">
                <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <div> <span class="btn default btn-file"> <span class="fileinput-new"> Seleccione imagen de perfil </span> <span class="fileinput-exists"> Change </span> {!! Form::file('image', null, array('id'=>'image')) !!} </span> <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput"> Remove </a> </div>
                </div>
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'first_name') !!}">
        ...
        {!! Form::text('first_name', null, array('class'=>'form-control', 'id'=>'first_name', 'placeholder'=>'Primer nombre')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'middle_name') !!}">
        ...
        {!! Form::text('middle_name', null, array('class'=>'form-control', 'id'=>'middle_name', 'placeholder'=>'Segundo nombre')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'first_lastname') !!}">
        ...
        {!! Form::text('first_lastname', null, array('class'=>'form-control', 'id'=>'first_lastname', 'placeholder'=>'Apellidos')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'second_lastname') !!}">
        ...
        {!! Form::text('second_lastname', null, array('class'=>'form-control', 'id'=>'second_lastname', 'placeholder'=>'Apellidos')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'father_name') !!}">
        ...
        {!! Form::text('father_name', null, array('class'=>'form-control', 'id'=>'father_name', 'placeholder'=>'Nombre del padre')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'date_of_birth') !!}">
        ...
        {!! Form::date('date_of_birth', null, array('class'=>'form-control', 'id'=>'date_of_birth', 'placeholder'=>'Fecha de nacimiento', 'autocomplete'=>'off')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}">
        ...
        {!! Form::select('gender_id', [''=>'Seleccione Género']+$genders, null, array('class'=>'form-control', 'id'=>'gender_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'marital_status_id') !!}">
        ...
        {!! Form::select('marital_status_id', [''=>'Seleccione Población']+$maritalStatuses, null, array('class'=>'form-control', 'id'=>'marital_status_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'nationality_id') !!}">
        ...
        {!! Form::select('nationality_id', [''=>'Seleccione Nacionalidad']+$nationalities, null, array('class'=>'form-control', 'id'=>'nationality_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'national_id_card_number') !!}">
        ...
        {!! Form::text('national_id_card_number', null, array('class'=>'form-control', 'id'=>'national_id_card_number', 'placeholder'=>'Número de identificación')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'country_id') !!}">
        ...
        {!! Form::select('country_id', [''=>'Seleccione País']+$countries, old('country_id', (isset($user))? $user->country_id:$siteSetting->default_country_id), array('class'=>'form-control', 'id'=>'country_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'phone') !!}">
        ...
        {!! Form::text('phone', null, array('class'=>'form-control', 'id'=>'phone', 'placeholder'=>'Teléfono')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'mobile_num') !!}">
        ...
        {!! Form::text('mobile_num', null, array('class'=>'form-control', 'id'=>'mobile_num', 'placeholder'=>'Número de celular')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}">
        ...
        {!! Form::select('job_experience_id', [''=>'Seleccione Experiencia']+$jobExperiences, null, array('class'=>'form-control', 'id'=>'job_experience_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'current_salary') !!}">
        ...
        {!! Form::text('current_salary', null, array('class'=>'form-control', 'id'=>'current_salary', 'placeholder'=>'Salario actual')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'expected_salary') !!}">
        ...
        {!! Form::text('expected_salary', null, array('class'=>'form-control', 'id'=>'expected_salary', 'placeholder'=>'Expectativa de salario')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}">
        ...
        {!! Form::text('salary_currency', null, array('class'=>'form-control', 'id'=>'salary_currency', 'placeholder'=>'Moneda', 'autocomplete'=>'off')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'street_address') !!}">
        ...
        {!! Form::textarea('street_address', null, array('class'=>'form-control', 'id'=>'street_address', 'placeholder'=>'Dirección')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_seeker_package_id') !!}"> {!! Form::label('job_seeker_package_id', 'plan', ['class' => 'bold']) !!}
        {!! Form::select('job_seeker_package_id', ['' => 'Seleccione plan']+$packages, null, array('class'=>'form-control', 'id'=>'job_seeker_package_id')) !!}
    ...
    {!! Form::button('Guardar información personal <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>', array('class'=>'btn btn-large btn-primary', 'type'=>'submit')) !!}
</div>
{!! Form::close() !!}
@push('css')
<style type="text/css">
