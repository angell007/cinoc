                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" id="created_at" aria-describedby="created_at"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="identifier">Documento</label>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" id="functional_area" aria-describedby="functional_area"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" id="sexo" aria-describedby="sexo"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" id="segmento" aria-describedby="segmento"
