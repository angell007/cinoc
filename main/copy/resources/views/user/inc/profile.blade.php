...
{{-- @php
    $totalFields = 29; // Número total de campos en el perfil
    $completedFields = 0;

    // Verificar cada campo y aumentar el contador si está completo
    $fields = [
        1 => $user->email,
        2 => $user->image,
        3 => $user->first_name,
    ...
    foreach ($fields as $field) {
        $completedFields += !empty($field) ? 1 : 0;
    }
...
<div class="progress mb-3">
    <div class="progress-bar" role="progressbar" style="width: {{ $completionPercentage }}%;"
        ...
        {{ round($completionPercentage) }}% Hoja de vida</div>
</div> --}}
...
<h5>{{ __('Personal Information') }}</h5>
    ...
    {{-- $personalFields = [
        ...
        24 => $user->mobile_num,
        25 => $user->street_address,
        26 => $user->travel_possibility,
        27 => $user->relocation_possibility,
        28 => $user->own_transport,
        29 => $user->non_formal_education,
        30 => $user->car_license,
        31 => $user->car_license_category,
        32 => $user->motorcycle_license,
        33 => $user->motorcycle_license_category,
        34 => $user->current_job_situation,
    ]; --}}
...
<div class="progress mb-3">
    <div class="progress-bar" role="progressbar" style="width: {{ $personalCompletionPercentage }}%;"
        ...
        {{ round($personalCompletionPercentage) }}% Información Personal</div>
</div>
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'first_lastname') !!}">
    ...
    <div class="col-md-6">
        ...
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'second_lastname') !!}">
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <select name="status_edu" id="status_edu">
            ...
            <option {{ $user->rol == 'Egresado' ? 'selected' : '' }} value="Egresado">Egresado</option>

            <option {{ $user->rol == 'Estudiante' ? 'selected' : '' }} value="Estudiante">Estudiante</option>
    ...
    <div class="col-md-6" id="praticas">
        ...
        <select name="status_parcticas" id="">
            ...
            <option {{ $user->status_parcticas == 'No' ? 'selected' : '' }} value="No">No</option>

            <option {{ $user->status_parcticas == 'Si' ? 'selected' : '' }} value="Si">Si</option>
    ...
    <div class="col-md-6" id="car_license_category_div" style="{{ isset($user) && $user->car_license == 'Si' ? 'display: block;' : 'display: none;' }}">
    ...
    <div class="col-md-6" id="motorcycle_license_category_div" style="{{ isset($user) && $user->motorcycle_license == 'Si' ? 'display: block;' : 'display: none;' }}">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'motorcycle_license_category') !!}">
            ...
            {!! Form::select('motorcycle_license_category', ['A1' => 'A1', 'A2' => 'A2'], $user->motorcycle_license_category ?? null, [
                'class' => 'form-control',
