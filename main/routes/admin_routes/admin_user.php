...
/* * ****** List CVs Routes ********** */
Route::get('send-cvs', 'Admin\AdminController@viewlistSendedcvs')->name('send-cvs');
Route::get('get-cvs-sended', 'Admin\AdminController@getsendedcvsList')->name('get-cvs-sended');
Route::get('get-cvs-sended-items/{id}', 'Admin\AdminController@getsendedcvs')->name('get-cvs-sended-items');
Route::get('list-sendedcvs-items/{id}', 'Admin\AdminController@viewlistSendedcvsItems')->name('list-sendedcvs-items');

/* * ****** Create/Delete CVs List Routes ********** */
Route::post('create-list-sendedcvs', 'Admin\AdminController@createlistSendedcvs')->name('create-list-sendedcvs');
Route::post('delete-list-sendedcvs', 'Admin\AdminController@deletelistSendedcvs')->name('delete-list-sendedcvs');
