...

{
...

    {
        ...
        // $logo = (null!==($logo)) ? $logo : 'perfil.png';

        $logo = (!empty($logo)) ? $logo : 'perfil.png';
...

    {
        ...
        if (!empty($this->google_plus))
            ...
            $html .= '<a href="' . $this->google_plus . '" target="_blank"><i class="fa fa-instagram-square" aria-hidden="true"></i></a>';
