    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>Tipo de Población</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Manage Tipo de Población <small>Tipo de Población</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Tipo de Población</span> </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="maritalStatusDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter">
                                            ...
                                            <td><input type="text" class="form-control" name="marital_status" id="marital_status" autocomplete="off" placeholder="Tipo de Población"></td>
...
<script>
    ...
    function deleteMaritalStatus(id, is_default) {
        ...
        if (is_default == 1) {
            msg = 'Are you sure? You are going to delete default Marital Status, all other non default Tipo de Población will be deleted too!';
        }
        if (confirm(msg)) {
