        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="userccount">
                    ...
                    <div class="formpanel">
                        <div class="formrow"> <span class="help-block text-danger"> <strong>{!! trans('laravel-user-verification::user-verification.verification_error_message') !!}</strong> </span> </div>
