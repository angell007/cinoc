...
class CompaniesController extends Controller
{
    ...
    public function updateCompanyProfile(CompanyFrontFormRequest $request)
    {
        ...
        flash(__('Una vez se active la empresa comunicar vía correo electrónico (a la empresa y al correo bolsadeempleo@itc.edu.co) que su cuenta para publicar ofertas laborales fue activada.'))->success();
