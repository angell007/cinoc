...
trait ProfileExperienceTrait
{
    public function showProfileExperience(Request $request, $user_id)
    {
        ...
        $html = '';
        if (isset($user) && count($user->profileExperience)) : foreach ($user->profileExperience as $experience) : if ($experience->is_currently_working == 1) {
            $date_end = 'Currently working';
        } else {
            $date_end = $experience->date_end ? $experience->date_end->format('d M, Y') : '';
        }
            ...
            $html .= '<!--experience Start--> <div class="col-md-12" id="experience_' . $experience->id . '"> <div class="mt-element-ribbon bg-grey-steel"> <div class="ribbon ribbon-color-warning uppercase ">' . $experience->title . '
                    ...
                    <br /> '  . $experience->date_start . ' - ' . $date_end . ' | ' . $experience->getCity('city') . '
...
<div class="panel-group">';
        if (isset($user) && count($user->profileExperience)) : foreach ($user->profileExperience as $experience) : if ($experience->date_end == '' || $experience->date_end == null) {
            $date_end = 'Laborando actualmente';
        } else {
