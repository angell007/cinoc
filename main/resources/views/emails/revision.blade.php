                                ...
                                <table border="0" width="590" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <p style="line-height: 24px;margin-bottom:15px;">
                                                El usuario {{ $user->name }} ha solicitado la revisión de su hoja de vida:
                                                <strong>{{ $user->title_cv }}</strong>
                                            </p>
                                            @if (!empty($user->is_platform_cv))
                                            <p style="line-height: 24px;margin-bottom:15px;">
                                                Documento: hoja de vida registrada en la plataforma.
                                                <a href="{{ route('edit.user', ['id' => $user->id]) }}">Ver perfil del candidato</a>
                                            </p>
                                            @elseif (!empty($user->file))
                                            <p style="line-height: 24px;margin-bottom:15px;">
                                                <a href="{{ url('download-cv', [$user->file, $user->title_cv, $user->id]) }}">Descargar archivo</a>
                                            </p>
                                            @endif
                                            
                                            <p style="line-height: 24px;margin-bottom:15px;">
                                               
                                                  Al finalizar debes enviar las sugerencias al email : {{ $user->email }}
