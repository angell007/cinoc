...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'borncountry_id') !!}">

        {!! Form::label('borncountry_id', 'País de naciemiento', ['class' => 'bold']) !!}

        {!! Form::select(
            'borncountry_id',
            ['' => 'Seleccione País'] + $countries,
            old('borncountry_id', isset($user) ? $user->borncountry_id : $siteSetting->default_country_id),
            ['class' => 'form-control form-control-xs', 'id' => 'borncountry_id'],
        ) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'bornstate_id') !!}">

        {!! Form::label('bornstate_id', 'Departamento de naciemiento', ['class' => 'bold']) !!}

        <span id="default_bornstate_dd">

            {!! Form::select('bornstate_id', ['' => 'Seleccione Departamento'], null, [
                'class' => 'form-control form-control-xs',
                'id' => 'bornstate_id',
            ]) !!}
        ...
        {!! APFrmErrHelp::showErrors($errors, 'bornstate_id') !!}

    </div>

    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'borncity_id') !!}">

        {!! Form::label('borncity_id', 'Ciudad de naciemiento', ['class' => 'bold']) !!}

        <span id="default_borncity_dd">

            {!! Form::select('borncity_id', ['' => 'Seleccione Ciudad'], null, [
                'class' => 'form-control form-control-xs',
                'id' => 'borncity_id',
            ]) !!}
        ...
        {!! APFrmErrHelp::showErrors($errors, 'borncity_id') !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}" id="functional_area_id_div">
        ...
        {!! Form::select('functional_area_id', ['' => 'Seleccione área funcional'] + $functionalAreas, null, [
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'travel_possibility') !!}">
        {!! Form::label('travel_possibility', 'Posibilidad de Viajar', ['class' => 'bold']) !!}
        <div class="radio-list">
            <label class="radio-inline">
                {!! Form::radio('travel_possibility', 1, null, ['id' => 'travel_possibility_si']) !!} Sí
            </label>
            <label class="radio-inline">
                {!! Form::radio('travel_possibility', 0, null, ['id' => 'travel_possibility_no']) !!} No
            </label>
        </div>
        {!! APFrmErrHelp::showErrors($errors, 'travel_possibility') !!}
    </div>

    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'relocation_possibility') !!}">
        {!! Form::label('relocation_possibility', 'Posibilidad de Reubicación', ['class' => 'bold']) !!}
        <div class="radio-list">
            <label class="radio-inline">
                {!! Form::radio('relocation_possibility', 1, null, ['id' => 'relocation_possibility_si']) !!} Sí
            </label>
            <label class="radio-inline">
                {!! Form::radio('relocation_possibility', 0, null, ['id' => 'relocation_possibility_no']) !!} No
            </label>
        </div>
        {!! APFrmErrHelp::showErrors($errors, 'relocation_possibility') !!}
    </div>

    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'own_transport') !!}">
        {!! Form::label('own_transport', 'Transporte Propio', ['class' => 'bold']) !!}
        <div class="radio-list">
            <label class="radio-inline">
                {!! Form::radio('own_transport', 1, null, ['id' => 'own_transport_si']) !!} Sí
            </label>
            <label class="radio-inline">
                {!! Form::radio('own_transport', 0, null, ['id' => 'own_transport_no']) !!} No
            </label>
        </div>
        {!! APFrmErrHelp::showErrors($errors, 'own_transport') !!}
    </div>

    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'car_license') !!}">
        {!! Form::label('car_license', 'Licencia de Conducir (Carro)', ['class' => 'bold']) !!}
        <div class="radio-list">
            <label class="radio-inline">
                {!! Form::radio('car_license', 1, null, ['id' => 'car_license_si']) !!} Sí
            </label>
            <label class="radio-inline">
                {!! Form::radio('car_license', 0, null, ['id' => 'car_license_no']) !!} No
            </label>
        </div>
        {!! APFrmErrHelp::showErrors($errors, 'car_license') !!}
    </div>

    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'car_license_category') !!}">
        {!! Form::label('car_license_category', 'Categoría de Licencia de Carro', ['class' => 'bold']) !!}
        {!! Form::text('car_license_category', null, [
            'class' => 'form-control form-control-xs',
            'id' => 'car_license_category',
            'placeholder' => 'Categoría de Licencia de Carro',
        ]) !!}
        {!! APFrmErrHelp::showErrors($errors, 'car_license_category') !!}
    </div>

    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'motorcycle_license') !!}">
        {!! Form::label('motorcycle_license', 'Licencia de Conducir (Moto)', ['class' => 'bold']) !!}
        <div class="radio-list">
            <label class="radio-inline">
                {!! Form::radio('motorcycle_license', 1, null, ['id' => 'motorcycle_license_si']) !!} Sí
            </label>
            <label class="radio-inline">
                {!! Form::radio('motorcycle_license', 0, null, ['id' => 'motorcycle_license_no']) !!} No
            </label>
        </div>
        {!! APFrmErrHelp::showErrors($errors, 'motorcycle_license') !!}
    </div>

    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'motorcycle_license_category') !!}">
        {!! Form::label('motorcycle_license_category', 'Categoría de Licencia de Moto', ['class' => 'bold']) !!}
        {!! Form::text('motorcycle_license_category', null, [
            'class' => 'form-control form-control-xs',
            'id' => 'motorcycle_license_category',
            'placeholder' => 'Categoría de Licencia de Moto',
        ]) !!}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change', '#bornstate_id', function(e) {
                ...
                filterBornDefaultCities(0);

            });

            filterBornDefaultStates(<?php echo old('bornstate_id', isset($user) ? $user->bornstate_id : 0); ?>);
        ...
        function filterBornDefaultStates(state_id) {

            var borncountry_id = $('#borncountry_id').val();

            if (borncountry_id != '') {

                $.post("{{ route('filter.default.states.dropdown') }}", {

                        country_id: borncountry_id,
                    ...
                    .done(function(res) {
                        ...
                        select.id = 'bornstate_id';
                        select.name = 'bornstate_id';

                        var response = select.outerHTML;

                        $('#default_bornstate_dd').html(response);

                        filterBornDefaultCities(<?php echo old('borncity_id', isset($user) ? $user->borncity_id : 0); ?>);
        ...
        function filterBornDefaultCities(city_id) {

            var bornstate_id = $('#bornstate_id').val();

            if (bornstate_id != '') {

                $.post("{{ route('filter.default.cities.dropdown') }}", {

                        state_id: bornstate_id,
                    ...
                    .done(function(res) {
                        ...
                        select.id = 'borncity_id';
                        select.name = 'borncity_id';

                        var response = select.outerHTML;

                        $('#default_borncity_dd').html(response);
