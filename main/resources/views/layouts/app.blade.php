...
@stack('styles')
    <style>
        ...
        <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-B4TYTGS5JT"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-B4TYTGS5JT');
    </script>
...
<body> @yield('content')
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script> {!! NoCaptcha::renderJs() !!}
