...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'civil_status') !!}">
        {!! Form::label('civil_status', 'Estado civil', ['class' => 'bold']) !!}
        {!! Form::text('civil_status', null, array('class'=>'form-control', 'id'=>'civil_status', 'placeholder'=>'Estado civil', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'civil_status') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_default') !!}">
        ...
        <div class="radio-list">
            ...
            $is_default_2 = '';
            if (old('is_default', ((isset($civilStatus)) ? $civilStatus->is_default : 1)) == 0) {
                $is_default_1 = '';
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'civil_status_id') !!}" id="civil_status_id_div">
        {!! Form::label('civil_status_id', 'Default Marital Status', ['class' => 'bold']) !!}                    
        {!! Form::select('civil_status_id', ['' => 'Select Default Marital Status']+$civilStatuses, null, array('class'=>'form-control', 'id'=>'civil_status_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_active') !!}">
        ...
        <div class="radio-list">
            ...
            $is_active_2 = '';
            if (old('is_active', ((isset($civilStatus)) ? $civilStatus->is_active : 1)) == 0) {
                $is_active_1 = '';
...
<script type="text/javascript">
    ...
    function showHideMaritalStatusId() {
        $('#civil_status_id_div').hide();
        var is_default = $("input[name='is_default']:checked").val();
        if (is_default == 0) {
            $('#civil_status_id_div').show();
        }
    }
