...
<div class="section greybg">
    <div class="container">
        <div class="topsearchwrap">
			<div class="tabswrap">
				<div class="row">
					<div class="col-md-4"><h3>Buscar empleo por: </h3></div>
					<div class="col-md-8">
						<ul class="nav nav-tabs" id="myTab" role="tablist">
						  <li class="nav-item"><a data-toggle="tab" href="#byfunctional" class="nav-link active" aria-expanded="true">Área funcional</a></li>
						  <li class="nav-item"><a data-toggle="tab" class="nav-link" href="#bycities" aria-expanded="false">Ciudades</a></li>
						  <li class="nav-item"><a data-toggle="tab" href="#byindustries" class="nav-link" aria-expanded="false">Sector Productivo</a></li>
						</ul>
					</div>
				</div>
 ...
 <?php endif; ?><?php /**PATH C:\laragon\www\cinoc\main\resources\views/includes/popular_searches.blade.php ENDPATH**/ ?>