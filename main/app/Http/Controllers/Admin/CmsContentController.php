            ...
            ->addColumn('action', function ($cmsContent) {
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.cmsContent', ['id' => $cmsContent->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Editar</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="delete_cmsContent(' . $cmsContent->id . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Eliminar</a>
						</li>																																							
					</ul>
				</div>';
            })
