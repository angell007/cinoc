                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions"> <a href="{{ route('create.job.type') }}" class="btn btn-xs btn-success"><i
                                        class="glyphicon glyphicon-plus"></i> Add New Job Type</a> </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="jobTypeDatatableAjax">
                                        ...
                                        <thead>
                                            ...
                                            <tr role="row" class="filter">
                                                ...
                                                <td><input type="text" class="form-control" name="job_type"
                                                        id="job_type" autocomplete="off" placeholder="Job Type"></td>
    ...
    <script>
        ...
        function deleteJobType(id, is_default) {
            ...
            if (is_default == 1) {
                ...
                msg =
                    'Are you sure? You are going to delete default Job Type, all other non default Job Types will be deleted too!';

            }

            if (confirm(msg)) {

                $.post("{{ route('delete.job.type') }}", {
                        id: id,
                        _method: 'DELETE',
                        _token: '{{ csrf_token() }}'
                    })
        ...
        function makeActive(id) {
            ...
            $.post("{{ route('make.active.job.type') }}", {
                    id: id,
                    _method: 'PUT',
                    _token: '{{ csrf_token() }}'
                })
        ...
        function makeNotActive(id) {
            ...
            $.post("{{ route('make.not.active.job.type') }}", {
                    id: id,
                    _method: 'PUT',
                    _token: '{{ csrf_token() }}'
                })
