...
@include('includes.inner_page_title', ['page_title'=>__('Perfil Publico de la Empresa')])
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8">
                        ...
                        <div class="candidateinfo">
                            ...
                            <div class="loctext text-center"><i class="fa fa-tachometer" aria-hidden="true"></i>

                                <a href="{{route('company.home')}}"> Tablero de Control </a>
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <h5>{{__('Login to View contact details')}}</h5>
            ...
            <div class="col-md-8">
                ...
                <div class="relatedJobs">
                    ...
                    <ul class="searchList">
                        ...
                        @foreach($company->jobs()->whereDate('expiry_date' , '>' , \Carbon\Carbon::now() )->where('is_active', 1)->get() as $companyJob)
                        ...
                        <li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="listbtn"><a href="{{route('job.detail', [$companyJob->slug])}}">{{__('View Detail')}}</a>
                    ...
                    <div class="jobdetail">
                        ...
                        <ul class="jbdetail">
                            ...
                            <li class="row">
                                ...
                                <div class="col-md-6 col-xs-6">Verificación de NIT</div>

                                <div class="col-md-6 col-xs-6"><span>{{((bool)$company->verified)? 'Si':'No'}}</span>
