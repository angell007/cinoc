<div class="col-md-3 col-sm-4">
    ...
    <ul class="usernavdash">
        ...
        <li><a href="{{ route('post.job') }}"><i class="fa fa-desktop" aria-hidden="true"></i> Publica una oferta  </a></li>
        ...
        <li><a href="{{route('info')}}"><i class="fa fa-question-circle" aria-hidden="true"></i> Orientación ocupacional </a></li>
