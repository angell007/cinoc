<!-- Modal -->
<div class="modal fade" id="fileModalUploadedMassiveParticipantsStudens" tabindex="-1" role="dialog"
    aria-labelledby="fileModalUploadedMassiveParticipantsStudens" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('file-import-trainings-participants') }}" method="post"
