<div class="userloginbox">
	<div class="container">
		<div class="titleTop">
			<h3>Bolsa de Empleo de la UNIOC</h3>
		</div>
		<p class="text-dark " style="font-weight: 900;">
		    La Bolsa de Empleo de la UNIOC busca ser la primera opción para sus Egresados y Estudiantes en la búsqueda de empleo.
		</p>
		<p class="align-content">
                    Facilitar el acercamiento entre los oferentes, estudiantes y egresados, de la Bolsa de
                    Empleo de la Institución Universitaria Oriente de Caldas – UNIOC que están en disposición de ofrecer sus servicios, y los demandantes,
                    ...
                    mercado laboral de los Egresados y Estudiantes de la UNIOC, a través de la
                    ...
                    Estudiantes activos y Egresados de la Institución Universitaria Oriente de Caldas – UNIOC.
		</p>
