                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2">
                                <strong>{{ __('Posibilidad de trasladarse de lugar de residencia') }}:</strong> <span
                                    class="float-right">{{ $user->relocation_possibility }}</span>
                            </li>
                            ...
                            @if ($user->car_license == 'Si')
                                <li class="mb-2">
                                    <strong>{{ __('Categoría de licencia de conducción para carro') }}:</strong> <span
                                        class="float-right">{{ $user->car_license_category }}</span>
                                </li>
                            @endif
                            ...
                            @if ($user->motorcycle_license == 'Si')
                                <li class="mb-2">
                                    <strong>{{ __('Categoría de licencia de conducción para moto') }}:</strong> <span
                                        class="float-right">{{ $user->motorcycle_license_category }}</span>
                                </li>
                            @endif
                        </ul>
                    </div>
...
@push('scripts')
    <script type="text/javascript">
        ...
        function send_message() {
            ...
            el.innerHTML =
                "Por favor <a class='btn' href='{{ route('login') }}' onclick='set_session()'>inicia sesión</a> como Empresa y vuelve a intentarlo."
            @if (null !== Auth::guard('company')->user())
                $('#sendmessage').modal('show');
                console.log('send_message inside if');
            @else
                Swal.fire({
                ...
                console.log('send_message inside else');
            @endif
            console.log('send_message after if else');
        }
