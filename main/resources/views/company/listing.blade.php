    ...
    <div class="container">
        <section id="joblisting-header" role="search" class="searchform">
            <form id="top-search" method="GET" action="{{route('company.listing')}}">
                <div class="row">
                    <div class="col-lg-9">
                        <input type="text" name="search" value="{{Request::get('search', '')}}" class="form-control search" placeholder="{{__('Buscar Empresa')}}" />
                    </div>
                    <div class="col-lg-3">
                        <button type="submit" id="submit-form-top" class="btn"><i class="fa fa-search" aria-hidden="true"></i> {{__('Buscar Empresa')}}</button>
                    </div>
                </div>
            </form>
        </section>
...
<div class="listpgWraper">
    <div class="container">
        <ul class="row compnaieslist">
            ...
            <li class="col-md-3 col-sm-6" style="">
                <div class="compint" style="height: 30em !important;">
                    <div class="imgwrap"><a href="{{route('company.detail',$company->slug)}}">
