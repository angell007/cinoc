    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="{{ route('list.genders') }}">Gender</a> <i class="fa fa-circle"></i> </li>
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">          
                        ...
                        {!! Form::model($gender, array('method' => 'put', 'route' => array('update.gender', $gender->id), 'class' => 'form', 'files'=>true)) !!}
                        {!! Form::hidden('id', $gender->id) !!}            
