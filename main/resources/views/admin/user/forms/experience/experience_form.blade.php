<div class="modal-body p-2">
    <div class="form-body">
        ...
        <div class="formrow" id="div_country_id"> <?php $country_id = isset($profileExperience) ? $profileExperience->country_id : ''; ?>
        ...
        <div class="formrow " id="div_is_currently_working">
            ...
            <div class="">
                ...
                <label class="radio-inline">
                    <input id="currently_working" name="is_currently_working" type="radio" value="1"
                        {{ $val_1_checked }}> {{ __('Yes') }}
                </label>

                <label class="radio-inline">

                    <input id="not_currently_working" name="is_currently_working" type="radio" value="0"
                        {{ $val_2_checked }}> {{ __('No') }}
                </label>
