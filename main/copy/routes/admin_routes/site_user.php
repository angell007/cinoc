...
Route::post('show-profile-education-non-formal/{id}', array_merge(['uses' => 'Admin\UserController@showProfileEducationNonFormal'], $all_users))->name('show.profile.education_non_formal');

Route::post('get-profile-education-non-formal-form/{id}', array_merge(['uses' => 'Admin\UserController@getProfileEducationNonFormalForm'], $all_users))->name('get.profile.education_non_formal.form');

Route::post('store-profile-education-non-formal/{id}', array_merge(['uses' => 'Admin\UserController@storeProfileEducationNonFormal'], $all_users))->name('store.profile.education_non_formal');

Route::post('get-profile-education-non-formal-edit-form/{id}', array_merge(['uses' => 'Admin\UserController@getProfileEducationNonFormalEditForm'], $all_users))->name('get.profile.education_non_formal.edit.form');

Route::put('update-profile-education-non-formal/{education_non_formal_id}/{user_id}', array_merge(['uses' => 'Admin\UserController@updateProfileEducationNonFormal'], $all_users))->name('update.profile.education_non_formal');

Route::delete('delete-profile-education-non-formal', array_merge(['uses' => 'Admin\UserController@deleteProfileEducationNonFormal'], $all_users))->name('delete.profile.education_non_formal');
