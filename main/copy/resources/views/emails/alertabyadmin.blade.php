                                            ...
                                            <table width="360 " border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td width="120" align="center"
                                                        ...
                                                        <a href="" style="color: #312c32; text-decoration: none;">
                                                        </a>
                                                    </td>
                                                    <td width="120" align="center"
                                                        style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                    ...
                    <table border="0" align="center" width="590" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td align="center"
                                ...
                                class="main-header">
                                <div style="line-height: 50px"> Estado de la vacante </div>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table border="0" width="590" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <p style="line-height: 24px; margin-bottom:15px;"> Administrador, </p>
                                            <p style="line-height: 24px;margin-bottom:15px;"> La aplicación de la oferta
                                                {{ $job->title }} de la empresa {{ $company->name }} ha pasado ha estado
                                                {{ $estado }} para el candidato {{ $user->first_name }}
                                                {{ $user->middle_name }} {{ $user->first_lastname }}
                                                {{ $user->second_lastname }} </p>
                                            ...
                                            <p style="line-height: 24px"> </br> {{ $siteSetting->site_name }} </p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
