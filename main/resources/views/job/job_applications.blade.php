            ...
            <div class="col-md-9 col-sm-8"> 
                <div class="myads">
                     ...
                     <div class="row mb-3 p-3 bg-white text-center">
                                ...
                                <div class="col-4">
                                    <select class="form-control" id="select" placeholder="Seleccione">
                                        <option value="">Seleccione</option>
                                        <option value="ciudad">Ciudad</option>
                                        <option value="edad">Rango de edad</option>
                                        <option value="expectativa">Expectativa salarial</option>
                                        <option value="educacion">Nivel Educativo</option>
                                        <option value="cargo">Cargo</option>
                                        <option value="experiencia">Años de experiencia en el cargo</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-2">
                                  <button class="btn btn-info btn-xs go">Filtrar</button>
                                </div>
                ...
                <div >
                     ...
                     @if($job_application->status=="entrevista")
                        <br>
                        <h5 class="text text-primary">En proceso de entrevista</h5>
                        <br>
                     @endif 
                     
                     @if($job_application->status=="espera")
                       
                    <a class=" entrevistar btn  btn-info" data-id="{{$user->id}}" data-compa="{{$company->id}}" data-job="{{$job_application->id}}" id="" href="#">Entrevistar</a>
                       
                     @endif 
                 
                    <a class=" contra btn mm-{{$job_application->id}} btn-success" data-id="{{$user->id}}" data-compa="{{$company->id}}" data-job="{{$job_application->id}}" id="" href="#">Contratar</a>
                    
                    <a id="" class=" recha btn btn-danger mm-{{$job_application->id}}" data-job="{{$job_application->id}}" data-id="{{$user->id}}" href="#">Anular</a>
