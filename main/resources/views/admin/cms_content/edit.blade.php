    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="{{ route('list.cmsContent') }}">C.M.S Content</a> <i class="fa fa-circle"></i> </li>
                <li> <span>Edit C.M.S Content</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">          
                        ...
                        {!! Form::model($cmsContent, array('method' => 'put', 'route' => array('update.cmsContent', $cmsContent->id), 'class' => 'form', 'files'=>true)) !!}
                        {!! Form::hidden('id', $cmsContent->id) !!}            
