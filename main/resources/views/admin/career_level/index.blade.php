    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>Nivel de estudios</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Manage Nivel de estudios <small>Nivel de estudios</small> </h3>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Nivel de estudios</span> </div>
...
<script>
    ...
    function deleteCareerLevel(id, is_default) {
        ...
        if (is_default == 1) {
            msg = 'Are you sure? You are going to delete default Career Level, all other non default Nivel de estudios will be deleted too!';
        }
        if (confirm(msg)) {
            $.post("{{ route('delete.career.level') }}", {
                    id: id,
                    _method: 'DELETE',
                    _token: '{{ csrf_token() }}'
                })
    ...
    function makeActive(id) {
        $.post("{{ route('make.active.career.level') }}", {
                id: id,
                _method: 'PUT',
                _token: '{{ csrf_token() }}'
            })
    ...
    function makeNotActive(id) {
        $.post("{{ route('make.not.active.career.level') }}", {
                id: id,
                _method: 'PUT',
                _token: '{{ csrf_token() }}'
            })
