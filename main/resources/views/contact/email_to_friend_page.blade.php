                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="formrow{{ $errors->has('job_url') ? ' has-error' : '' }}">
                                    ...
                                    @if ($errors->has('job_url')) <span class="help-block text-danger"> <strong>{{ $errors->first('job_url') }}</strong> </span> @endif </div>
                            </div>
                            <div class="col-md-12">
                                <div class="formrow{{ $errors->has('friend_name') ? ' has-error' : '' }}">
                                    ...
                                    @if ($errors->has('friend_name')) <span class="help-block text-danger"> <strong>{{ $errors->first('friend_name') }}</strong> </span> @endif </div>
                            </div>
                            <div class="col-md-12">
                                <div class="formrow{{ $errors->has('friend_email') ? ' has-error' : '' }}">
                                    ...
                                    @if ($errors->has('friend_email')) <span class="help-block text-danger"> <strong>{{ $errors->first('friend_email') }}</strong> </span> @endif </div>
                            </div>
                            <div class="col-md-12">
                                <div class="formrow{{ $errors->has('your_name') ? ' has-error' : '' }}">
                                    ...
                                    @if ($errors->has('your_name')) <span class="help-block text-danger"> <strong>{{ $errors->first('your_name') }}</strong> </span> @endif </div>
                            </div>
                            <div class="col-md-12">
                                <div class="formrow{{ $errors->has('your_email') ? ' has-error' : '' }}">
                                    ...
                                    @if ($errors->has('your_email')) <span class="help-block text-danger"> <strong>{{ $errors->first('your_email') }}</strong> </span> @endif </div>
                            </div>
                            <div class="col-md-12">
