    ...
    <div class="container">  
        ...
        <div class="job-header">
            ...
            <div class="jobButtons">
                ...
                @else
                <a href="{{route('add.to.favourite.applicant', [$job_application->id, $user->id, $job->id, $company->id])}}" class="btn"><i class="fa fa-floppy-o" aria-hidden="true"></i> {{__('Agregar a favoritos')}}</a>
                @endif
                @endif
                ...
                <div class="job-header">
                    <div class="contentbox">
                        <h3>Aspiraciones del candidato</h3>
                ...
                <!-- About Employee start -->
                        @if(isset($user->letter) && $user->letter != '')
                            <div class="job-header">
                                <div class="contentbox">
                                         <a class="btn btn-warning py-3" href="{{url('donwload-letter', ['candidato' => $user] )}}">Carta de presentación</a>
                                </div>
                            </div>
                         @endif
