        ...
        <div class="job-header">
                    ...
                    <div class="jobdetail">
                       <h3><i class="fa fa-align-left" aria-hidden="true"></i> {{__('Job Detail')}}</h3>
                            ...
                            <li class="row">
                                ...
                                <div class="col-md-8 col-xs-7"><span>{{$job->getFunctionalArea('functional_area')}}</span></div>
                            </li>
                            <li class="row">
            ...
            <div class="jobButtons">
				...
				<div class="job-header benefits">
                    <div class="contentbox">
                        <h3><i class="fa fa-file-text-o" aria-hidden="true"></i> {{__('Beneficios')}}</h3>
                        <p>{!! $job->benefits !!}</p>                       
                    </div>
                </div>
...
@endpush
@push('scripts') 
<script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=5fd038d5de53210018c5d852&product=inline-share-buttons" async="async"></script>
