...
<div class="page-content-wrapper"> 
    ...
    <div class="page-content"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="table-container">
                            ...
                            <table class="table table-striped table-bordered table-hover"  id="admin_entrepreneurship_datatable_ajax">
     ...
     @include('partials.modalImportsTrainingsEntrepreneurship')
...
<script>
            ...
            function delete_training(id) {
                        ...
                        $.post("{{ route('delete-training-entrepreneurship') }}", {
    ...
    $(function () {
        ...
        $('#admin_entrepreneurship_datatable_ajax').DataTable({
            ...
            ajax: '{!! route("get-list-trainings-entrepreneurship") !!}',
