...
@else
    {!! Form::open(['method' => 'post', 'route' => ['store.front.job'], 'class' => 'form']) !!}
@endif
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'title') !!}"> {!! Form::text('title', null, ['class' => 'form-control', 'id' => 'title', 'placeholder' => __('Job title')]) !!}
    ...
    <div class="col-md-12">
        ...
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'professions') !!}">
            ...
            {!! Form::select('position', [], [], ['class' => 'form-control selected-remote', 'id' => 'position']) !!}
    ...
    <div class="col-md-4">
        ...
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'state_id') !!}">
            ...
            <span id="default_state_dd"> {!! Form::select('state_id', ['' => __('Seleccione Departamento')], null, [
                'class' => 'form-control form-control-sm',
                'id' => 'state_id',
            ]) !!} </span> {!! APFrmErrHelp::showErrors($errors, 'state_id') !!}
    ...
    <div class="col-md-4">
        ...
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'city_id') !!}">
            ...
            <span id="default_city_dd"> {!! Form::select('city_id', ['' => __('Seleccione Ciudad')], null, [
                'class' => 'form-control form-control-sm',
                'id' => 'city_id',
            ]) !!} </span> {!! APFrmErrHelp::showErrors($errors, 'city_id') !!}
    ...
    <div class="col-md-6">
        ...
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}" id="functional_area_id_div"> {!! Form::select('functional_area_id', ['' => __('Select profession')] + $functionalAreas, null, [
            'class' => 'form-control',
    ...
    <div class="col-md-6">
        ...
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div"> {!! Form::select('degree_level_id', ['' => __('Select Required Degree Level')] + $degreeLevels, null, [
            'class' => 'form-control',
            'id' => 'degree_level_id',
        ]) !!}
    ...
    <div class="col-md-12">
        ...
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'is_pl') !!}"> {!! Form::label('is_pl', __('Práctica laboral?'), ['class' => 'bold']) !!}
            ...
            <div class="radio-list">
                ...
                <small class="text-danger">Si selecciona práctica laboral, se guardará el tipo de contrato como : Otra
                </small>
