            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Reportes</span> </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-container">
                            
                            <form action="{{route('download.reports')}}" method="POST" role="form" class="row" id="datatable-search-form">
                                @csrf
                            ...
                            <input name="inicio" type="date" class="form-control" id="formGroupExampleInput">
                            </div>
                            
                            <div class="col-md-6 form-group">
                            <label for="formGroupExampleInput2">Fecha fin</label>
                            <input name="fin" type="date" class="form-control" id="formGroupExampleInput2" >
                            </div>
