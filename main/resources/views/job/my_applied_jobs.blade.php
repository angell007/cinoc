            ...
            <div class="col-md-9 col-sm-8"> 
                <div class="myads">
                    ...
                    <ul class="searchList">
                      ...
                      <label style="background-color:orange; color:white; margin:6px; padding: 5px;">Estado: {{$job->status}}</label>
                      @elseif($job->status=="contratado")
                      <label style="background-color:blue; color:white; margin:6px; padding: 5px;">Estado: {{$job->status}}</label>
                      @else
                      <label style="background-color:red; color:white; margin:6px; padding: 5px;">Estado: {{$job->status}}</label>
