<div class="modal-body">
    ...
    <div class="form-body">
        ...
        <div class="formrow" id="div_country_id"> <?php $country_id = isset($profileEducation) ? $profileEducation->country_id : $siteSetting->default_country_id; ?>
        ...
        <div class="formrow" id="div_education_status">
            <label for="education_status">{{ __('Estado de formación') }}</label>
            {!! Form::select(
                'education_status',
                [
                    '' => __('Seleccione el estado de formación'),
                    'en_curso' => __('En curso'),
                    'incompleto' => __('Incompleto'),
                    'graduado' => __('Graduado'),
                ],
                isset($profileEducation) ? $profileEducation->education_status : null,
                [
                    'class' => 'form-control',
                    'id' => 'education_status',
                ],
            ) !!}
            <span class="help-block text-danger education_status-error"></span>
        </div>
    </div>
</div>
