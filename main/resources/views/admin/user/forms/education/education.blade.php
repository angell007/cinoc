...
<div class="form-body">
    <div class="form-group">
        <button class="btn purple btn-outline sbold" onclick="showProfileEducationModal();">
            Nuevo estudio
        </button>
    </div>
    <div class="row">
            ...
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Educación
                        </span>
                    </div>
                </div>
        ...
        function loadProfileEducationEditForm(education_id, state_id, city_id, degree_type_id) {
            $.ajax({
                ...
                success: async function(json) {
                    ...
                    await filterLangStatesEducation(state_id, city_id);
                    await filterDegreeTypes(degree_type_id);
                    var degree_title = await document.getElementById('degree_title').getAttribute("value");
                    $('.selected-remote').select2({
                        width: 'resolve',
                        ajax: {
                            url: '/api/titles',
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '/api/titles?name=' + degree_title
                    }).then(function(data) {
