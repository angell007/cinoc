...
class DataArrayHelper
{
    ...
    {
        $array = CivilStatus::select('civil_statuses.civil_status', 'civil_statuses.civil_status_id')->isDefault()->active()->sorted()->pluck('civil_statuses.civil_status', 'civil_statuses.civil_status_id')->toArray();
        return $array;
    }

    public static function langCivilStatusesArray()
    {
        $array = CivilStatus::select('civil_statuses.civil_status', 'civil_statuses.civil_status_id')->lang()->active()->sorted()->pluck('civil_statuses.civil_status', 'civil_statuses.civil_status_id')->toArray();
        if ((int) count($array) === 0) {
            $array = [];
            // $array = self::defaultMaritalStatusesArray();
        }
    ...
    public static function defaultFunctionalAreasArray()
    {
        $array = FunctionalArea::select('functional_areas.functional_area', 'functional_areas.functional_area_id')
            ...
            ->active()
            ->sorted()
            ->pluck('functional_areas.functional_area', 'functional_areas.functional_area_id')->toArray();
        return $array;
    }
    ...
    {
        $array = Language::select('languages.lang', 'languages.id')->active()->sorted()->sorted()->pluck('languages.lang', 'languages.id')->toArray();
        return $array;
    }
    ...
    {
        $array = JobSkill::select('*')->lang()->active()->sorted()->pluck('job_skill', 'job_skill_id')->toArray();
    ...
    {
        $array = CountryDetail::select('countries_details.code', 'countries_details.currency')->whereNotNull('countries_details.code')->orderBy('countries_details.code')->pluck('countries_details.code' . 'countries_details.currency', 'countries_details.code')->toArray();
