...
<div class="form-body">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'lang') !!}">
        {!! Form::label('lang', 'Lenguaje', ['class' => 'bold']) !!}                    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'country') !!}">
        {!! Form::label('country', 'País', ['class' => 'bold']) !!}                    
        {!! Form::text('country', null, array('class'=>'form-control', 'id'=>'country', 'placeholder'=>'País', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'country') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'nationality') !!}">
        {!! Form::label('nationality', 'Nacionalidad', ['class' => 'bold']) !!}                    
        {!! Form::text('nationality', null, array('class'=>'form-control', 'id'=>'nationality', 'placeholder'=>'Nacionalidad', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'nationality') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_default') !!}">
        {!! Form::label('is_default', 'Por defecto?', ['class' => 'bold']) !!}
