            ...
            <li class="col-md-6">
                <div class="jobint">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3"><a href="<?php echo e(route('job.detail', [$featuredJob->slug])); ?>" class="applybtn"><?php echo e(__('View Detail')); ?></a></div>
                    </div>
                </div>
            </li>
            <!--Job end--> 
...
</div><?php /**PATH C:\laragon\www\cinoc\main\resources\views/includes/featured_jobs.blade.php ENDPATH**/ ?>