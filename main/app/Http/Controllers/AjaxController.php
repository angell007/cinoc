...
class AjaxController extends Controller
{
    ...
    public function filterDefaultStates(Request $request)
    {
        ...
        $dd = Form::select('state_id', ['' => __('Select State')] + $states, $state_id, array('id' => $new_state_id, 'class' => 'form-control select2-custom'));
        echo $dd;
    }
    ...
    public function filterDefaultCities(Request $request)
    {
        ...
        $dd = Form::select('city_id', ['' => 'Seleccione Ciudad'] + $cities, $city_id, array('id' => 'city_id', 'class' => 'form-control select2-custom'));
        echo $dd;
    }
    ...
    public function filterLangCities(Request $request)
    {
        ...
        $dd = Form::select('city_id', ['' => 'Seleccione Ciudad'] + $cities, $city_id, array('id' => 'city_id', 'class' => 'form-control'));
        echo $dd;
    }
    ...
    public function filterStates(Request $request)
    {
        ...
        $new_state_id = $request->input('new_state_id', 'state_id');
        $states = DataArrayHelper::langStatesArray($country_id);
        $dd = Form::select('state_id[]', ['' => __('Por favor seleccione Deparamento')] + $states, $state_id, array('id' => $new_state_id, 'class' => 'form-control form-control-custom'));
        echo $dd;
    }
    ...
    public function filterCities(Request $request)
    {
        ...
        $dd = Form::select('city_id[]', ['' => 'Seleccione Ciudad'] + $cities, $city_id, array('id' => 'city_id', 'class' => 'form-control form-control-custom'));
        echo $dd;
    }
