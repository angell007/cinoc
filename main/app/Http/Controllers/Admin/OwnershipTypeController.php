            ...
            ->addColumn('action', function ($ownershipTypes) {
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.ownership.type', ['id' => $ownershipTypes->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Editar</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteOwnershipType(' . $ownershipTypes->id . ', ' . $ownershipTypes->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Eliminar</a>
						</li>
						<li>
