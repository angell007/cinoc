<div class="col-lg-3">
    ...
    <ul class="usernavdash">
        ...
        <li><a href="{{route('download.my.cv')}}"><i class="fa fa-folder-o" aria-hidden="true"></i> {{__('Descargar mi hoja de vida')}}</a>
        </li>
        <li><a href="{{route('info')}}"><i class="fa fa-question-circle" aria-hidden="true"></i> Orientación ocupacional </a>
        </li>
