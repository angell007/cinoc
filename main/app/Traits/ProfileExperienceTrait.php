...
trait ProfileExperienceTrait
{
    ...
    public function showFrontProfileExperience(Request $request, $user_id)
    {
        ...
        if (isset($user) && count($user->profileExperience)):
            foreach ($user->profileExperience as $experience):
                if ($experience->date_end == '' || $experience->date_end == null )
                ...
                $html .= '<div class="panel panel-info" id="experience_' . $experience->id . '">
						...
						<div class="panel-footer">
						  ...
						  onclick="delete_profile_experience(' . $experience->id . ');
					      "class="text text-danger">' . __('Delete') . '</a>
					      
					      
						  <a href="javascript:void(0);"
						  onclick="showProfileExperienceEditModal(' . $experience->id . ',' . $experience->state_id . ',' . $experience->city_id . '); 
						  "class="text text-default">' . __('Edit') . '</a>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">Desde ' . $experience->date_start->format('d M, Y') . ' - ' . $date_end . '</div>
                    </div>
    ...
    public function storeFrontProfileExperience(ProfileExperienceFormRequest $request, $user_id)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            $fileName = ImgUploader::UploadImage('experiences_file', $image, $request->input('file'), 300, 300, false);
    ...
    public function deleteProfileExperience(Request $request)
    {
        ...
        try {
            ...
            File::delete(ImgUploader::real_public_path() . 'experiences_file/' . $profileExperience->adjunto);
