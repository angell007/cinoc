...
include_once($real_path . 'civil_status.php');
...
Route::get('/filter-user', 'Admin\UserController@indexFilter')->name('filter.user');
Route::get('/filter-user-data', 'Admin\UserController@dataFilter')->name('fetch.data.filter');
