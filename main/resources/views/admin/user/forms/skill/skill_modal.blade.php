    ...
    <div class="modal-content">
        <form class="form" id="add_edit_profile_skill" method="POST" action="{{ route('store.profile.skill', [$user->id]) }}">{{ csrf_field() }}
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-large btn-primary" onClick="submitProfileSkillForm();">Guardar habilidad <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
            </div>
        </form>
    </div>
    <!-- /.modal-content -->
