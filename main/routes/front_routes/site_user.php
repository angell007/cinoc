...
Route::post('update-front-profile-aspirations/{id}', 'UserController@updateProfileAspirations')->name('update.front.profile.aspirations');
...
Route::post('update-front-profile-experience/{profile_experience_id}/{user_id}', 'UserController@updateFrontProfileExperience')->name('update.front.profile.experience');
