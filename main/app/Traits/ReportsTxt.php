...
trait ReportsTxt
{
    ...
    public function OferentesSemestralTxt()
    {
        ...
        foreach ($data as $datum) {
            ...
            fwrite($txt, iconv('UTF-8', 'Windows-1252', ($datum->cityborn) ? 'CO' . $this->separatorSingle : '' . $this->separatorSingle));
            fwrite($txt, iconv('UTF-8', 'Windows-1252', (isset($datum->cityborn)) ? substr($divipola_born_code, 0, 2) . $this->separatorSingle : '' . $this->separatorSingle));
            fwrite($txt, iconv('UTF-8', 'Windows-1252', (isset($datum->cityborn)) ? substr($divipola_born_code, 2, 5) . $this->separatorSingle : '' . $this->separatorSingle));
            fwrite($txt, iconv('UTF-8', 'Windows-1252', ($datum->gender_id == 1) ? 1 . $this->separatorSingle : 2  . $this->separatorSingle));
            fwrite($txt, iconv('UTF-8', 'Windows-1252', ($datum->city) ? 'CO' . $this->separatorSingle : '' . $this->separatorSingle));
