                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <h4><a href="<?php echo e(route('job.detail', [$latestJob->slug])); ?>" title="<?php echo e($latestJob->title); ?>"><?php echo e($latestJob->title); ?></a></h4>
                             ...
                             <?php endif; ?>
                             <?php if($latestJob->show_info == 'no'): ?>
                             <div class="company"> Importante empresa del sector - <span><?php echo e($latestJob->getCity('city')); ?></span></div>
                             <?php endif; ?>
                            <div class="jobloc">
...
</div><?php /**PATH C:\laragon\www\cinoc\main\resources\views/includes/latest_jobs.blade.php ENDPATH**/ ?>