...
use App\Mail\JobRejectedMailable;
    ...
    public function fetchJobsData(Request $request)
    {
        ...
        return Datatables::of($jobs)
            ...
            ->addColumn('action', function ($jobs) {
                ...
                if ((int) $jobs->is_active == 0) {
                    $rejectAction = '<li><a href="javascript:void(0);" onClick="rejectJob(' . $jobs->id . ');"><i class="fa fa-times" aria-hidden="true"></i>Rechazar vacante</a></li>';
                }
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.job', ['id' => $jobs->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Editar</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteJob(' . $jobs->id . ', ' . $jobs->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Eliminar</a>
						</li>
						<li>
