<!-- Modal -->
<div class="modal fade" id="fileModalUpTrainings" tabindex="-1" role="dialog" aria-labelledby="fileModalUpTrainings" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="fileModalUpLabel">Importar Listado de capacitacion</h5>
